...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div
        id="home"
        className="w-[100%] h-[600px] flex items-center gap-[32px] px-[40px] sm:px-[100px] bg-[#eaebed]"
      >
        <div className="h-full w-full sm:p-[24px] sm:w-[30%] relative">
          <div className="absolute bottom-32 sm:bottom-24 flex flex-col gap-[24px] catchphrase-sentence">
            <p className="text-[32px] sm:text-[40px] uppercase font-[600] main-text">
        ...
        <div className="hidden sm:w-[60%] h-full sm:flex sm:items-center sm:justify-end px-[40px] py-[40px]">
