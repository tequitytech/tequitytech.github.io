...
const Footer = () => {
  ...
  return (
    <div>
      <footer>
        <div class="bg-[#19335a] text-[#ffffff]">
          <div class="max-w-screen-xl py-10 px-4 sm:px-6 text-gray-800 sm:flex justify-between mx-auto">
            <div class="p-5 sm:w-8/12">
              <div className="flex flex-col items-center justify-center">
                ...
                <h3 class="font-bold text-[40px] mb-4 text-[#ffffff]">
                  Tequity
                </h3>
              </div>

              <div class="flex justify-center text-[#252525] uppercase text-sm">
                <button
                  onClick={() => scrollIntoView('home')}
                  type="button"
                  class="mr-2 text-[#ffffff]"
                >
                  Home
                </button>
                <button
                ...
                <button
                  onClick={() => scrollIntoView('ourServices')}
                  type="button"
                  class="mr-2 text-[#ffffff]"
                >
                  Services
            ...
            <div class="p-5 sm:w-4/12">
              <h3 class="font-medium text-lg text-[#ffffff] mb-4">
                Drop your details here and we'll get in touch with you shortly.
              </h3>
              <form className="flex flex-col items-center gap-[16px]">
                ...
                <button
                  type="submit"
                  className="bg-[#ffffff] w-full px-[16px] py-[8px] rounded-[5px] mt-[16px] hover:bg-[#252525] hover:text-[#ffffff] contact-us-btn"
                >
                  Get in touch
                </button>
              </form>
          ...
          <div class="flex py-5 m-auto text-[#ffffff] text-sm flex-col items-center border-t max-w-screen-xl">
            <p>© Copyright 2022. All Rights Reserved to Tequity.tech</p>
          </div>
        </div>
      </footer>
    </div>
